...
* Create a New Project
  ...
  #+BEGIN_EXAMPLE
  create_project.py -n *your_project_name*
  #+END_EXAMPLE
  
  For simplicity, assume your project name is /project/. Note that, by convention, the project name should be in lower case with no punctuation.
